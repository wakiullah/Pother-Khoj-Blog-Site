    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <form onSubmit={formSubmitHandler} className="w-full max-w-sm bg-white p-8 rounded shadow">
        ...
        <div className="mb-4">
          ...
          <Input id="email" name="email" type="email" placeholder="place your email" className="mt-1" required />
        </div>
        <div className="mb-4">
        ...
        <div className="mb-6">
          ...
          <Input id="confirm-password" name="confirm-password" type="password" placeholder="••••••••" className="mt-1" required />
        </div>
