        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link href={'/dashboard/users'}>
                <div className="bg-blue-100 p-4 rounded-lg shadow">
                    ...
                    <div className="flex items-center mt-2">
                        <span className="text-2xl font-bold text-blue-600">{users}</span>
            ...
            <Link href={'/dashboard/posts'}>
                <div className="bg-green-100 p-4 rounded-lg shadow">
                    ...
                    <div className="flex items-center mt-2">
                        <span className="text-2xl font-bold text-green-600">{posts}</span>
            ...
            <div className="bg-yellow-100 p-4 rounded-lg shadow">
                ...
                <div className="flex items-center mt-2">
                    <span className="text-2xl font-bold text-yellow-600">{pendingPost}</span>
            ...
            <div className="bg-green-100 p-4 rounded-lg shadow">
                ...
                <div className="flex items-center mt-2">
                    <span className="text-2xl font-bold text-green-600">{approvedPost}</span>
                    <svg className="w-5 h-5 ml-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
